...
Promise.allSettled([promise1, promise2, promise3]); // Waits for all, returns all results (success or failure)

Promise.any([promise1, promise2]); // Returns first successful promise
```
